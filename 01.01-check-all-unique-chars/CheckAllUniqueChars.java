...
public class CheckAllUniqueChars {
	...
	*/
	private static boolean checkAllUniqueCharsWithHashSet(String str) {
	...
	lowercase a-z only
	*/
	private static boolean checkAllUniqueCharsWithBitVector(String str) {
		int bitVector = 0;
	...
	O(1) extra space
	*/
	private static boolean checkAllUniqueCharsWithTraversal(String str) {
	...
	public static void main(String... args) {
		if (args.length == 1) {
			...
			System.out.println("\nUsing a bit vector...");
			System.out.println(checkAllUniqueCharsWithBitVector(args[0]) ? "All unique!" : "Contains duplicates");

			System.out.println("\nUsing traversal...");
			System.out.println(checkAllUniqueCharsWithTraversal(args[0]) ? "All unique!" : "Contains duplicates");
		} else {
